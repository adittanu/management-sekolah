...
import { MessageCircle, Search, Phone, Video, Paperclip, Send, MoreVertical, Check, CheckCheck, Smile, Mic, Image } from 'lucide-react';
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex justify-between items-start mb-1">
                                            <h4 className={cn("font-semibold text-sm truncate", activeChat?.id === contact.id ? "text-blue-700" : "text-slate-900")}>
                                                {contact.name}
                                            </h4>
                        ...
                        <>
                            <div className="h-16 px-6 border-b border-slate-200 bg-white flex items-center justify-between shadow-sm z-10">
                                <div className="flex items-center gap-4">
                                    <Avatar className="h-10 w-10 cursor-pointer">
                                        ...
                                        <AvatarFallback className="bg-blue-100 text-blue-600 font-bold">{activeChat.name.substring(0,2)}</AvatarFallback>
                                    </Avatar>
                                    <div>
                                        <h3 className="font-bold text-slate-800 cursor-pointer">{activeChat.name}</h3>
                            ...
                            <div className="h-20 bg-white border-t border-slate-200 px-6 flex items-center gap-4 shrink-0">
                                ...
                                <Input 
                                    ...
                                    className="flex-1 bg-slate-50 border-slate-200 focus-visible:ring-blue-600 h-11"
                                />
                                {msgInput.trim() ? (
                                    <Button onClick={handleSendMessage} className="h-11 w-11 rounded-full bg-blue-600 hover:bg-blue-700 shrink-0">
                    ...
                    <div className="w-72 bg-white border-l border-slate-200 hidden xl:block p-6">
                        <div className="text-center mb-6">
                            <Avatar className="h-24 w-24 mx-auto mb-4 border-4 border-slate-50">
                                <AvatarImage src={activeChat.avatar} />
                                <AvatarFallback className="bg-blue-100 text-blue-600 text-2xl font-bold">{activeChat.name.substring(0,2)}</AvatarFallback>
                            </Avatar>
                            <h2 className="text-lg font-bold text-slate-800">{activeChat.name}</h2>
                            <span className="inline-block px-3 py-1 bg-blue-50 text-blue-600 text-xs font-bold rounded-full mt-2 uppercase tracking-wide">
                                {activeChat.role}
                            </span>
                        </div>

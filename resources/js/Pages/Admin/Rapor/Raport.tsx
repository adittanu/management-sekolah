...
export default function Raport({ classrooms, students, raportData, raportHistory = [], filters }: Props) {
    ...
    const handleFilterChange = (overrides?: { classroomId?: string; studentId?: string; semester?: string; academicYear?: string; reportType?: string }) => {
        setIsFiltering(true);
        router.get(route('admin.rapor.view'), {
    ...
    const handleDownloadPdf = () => {
        ...
        window.location.href = route('admin.rapor.export-pdf') + '?' + params.toString();
    ...
    return (
        <AdminLayout title="Raport Siswa">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-100 p-6 rounded-2xl shadow-sm">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-600 text-sm mt-1">Lihat, cetak, dan ekspor lembar rapor digital siswa sesuai dengan standar kurikulum sekolah sebagai administrator.</p>
                        </div>
                    </div>
                </div>
                            ...
                            <Card className="border-slate-200 shadow-sm overflow-hidden">
                                ...
                                <CardContent className="pt-10 pb-16 flex flex-col items-center justify-center text-center max-w-md mx-auto">
                                    ...
                                    <p className="text-slate-500 text-sm mt-2 mb-6">
                                        Pilih siswa dari kelas untuk melihat seluruh ringkasan prestasi belajar, kehadiran, dan catatan perkembangan kepribadian.
                                    </p>
                                </CardContent>
                            </Card>
                        )}
